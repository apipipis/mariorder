                                ...
                                <div class="card mb-0 border-0 shadow-none">
                                    <div class="card-body p-sm-5">
                                        <div class="text-center mt-5">
                                            <h5 class="fs-3xl">Selamat Datang</h5>
                                            <p class="text-muted">Silahkan login untuk mengakses Mari Order ID</p>
                                        </div>
                                        <div class="p-2 mt-5">
                                            <form action="{{ route('loginProses') }}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative ">
                                                        <input type="text"
                                                            ...
                                                            id="username" placeholder="Masukkan username" name="email"
                                                            required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="auth-pass-reset" class="text-muted">Lupa Password</a>
                                                    </div>
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="password"
                                                            ...
                                                            placeholder="Masukkan password" id="password-input" required
                                                            name="password">
                                                        <button
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="auth-remember-check">Ingat Akun
                                                        Saya</label>
                                                </div>

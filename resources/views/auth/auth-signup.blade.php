                        ...
                        <div class="row g-0">
                            <div class="col-xxl-5">
                                <div class="card auth-card h-100 border-0 shadow-none d-none d-sm-block overflow-hidden mb-0"
                                    style="background-color:rgba(47, 118, 213, 0.8)">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                            ...
                                            <g mask="url(&quot;#SvgjsMask1083&quot;)" fill="none">
                                                <path
                                                    ...
                                                    stroke="rgba(255, 225, 225, 1)" stroke-width="2"></path>
                                                <path
                                    ...
                                    <div
                                        ...
                                        <div class="text-center">
                                            <h2 class="text-white fw-medium lh-base text-capitalize mb-3">Belum Yakin
                                                Mendaftar ? </h2>
                                            <span class="fw-medium lh-base text-capitalize mb-3 fs-2" style="color: rgb(255, 174, 0) ">Coba Fitur Demo</span>
                                            ...
                                            <form class="needs-validation" novalidate action="{{ route('registerProses') }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="text" class="form-control bg-light border-light pe-5" onpaste="return false" placeholder="Masukkan nomor telepon" id="phone-input" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required name="tel">
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" class="form-control password-input bg-light border-light pe-5" onpaste="return false" placeholder="Masukkan Password " id="password-input" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required name="password">
